...
public class CollisionManager {
    ...
    // Concentra toda a verificação de impactos do jogo, comparando a distância entre os elementos
    public void checkCollisions(Player player, EnemyManager enemyManager, ProjectileManager projectileManager, PowerUpManager powerUpManager, long currentTime) {
        ...
        // Verifica se o tiro do player acertou algum inimigo
        ...
        // Verifica se o player encostou em algum powerup para aplicar o efeito dele
        if (player.getState() == State.ACTIVE) {
    ...
    // Calcula a distância entre dois pontos para a colisão
